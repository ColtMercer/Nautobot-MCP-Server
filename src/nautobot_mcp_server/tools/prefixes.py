...
def get_prefixes_by_location(
    location_name: str, format: str = "json"
) -> dict[str, Any]:
    ...
    try:
        ...
        prefixes = nb.client.get_prefixes_by_location(location_name)
        ...
        logger.error(
            "Failed to get prefixes for location", location=location_name, error=str(e)
        )
        return {
            "success": False,
